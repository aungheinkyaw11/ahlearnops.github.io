+++
date = '2026-04-25T21:44:49+04:00'
draft = false
title = 'How to Track Down Risky Security Group Rules Across All of Your AWS Accounts using Lambda'
author = 'Aung Hein'
description = 'A step-by-step guide to scanning risky AWS security group rules across multiple accounts with Lambda, Organizations, STS, S3, and Slack.'
summary = 'Build a centralized AWS security audit workflow that finds risky internet-exposed security group rules across member and management accounts.'
tags = ['AWS', 'Security', 'Lambda', 'Organizations', 'EC2']
categories = ['Cloud Security', 'AWS']
ShowToc = true
TocOpen = true
[cover]
  image = 'assets/architecture.png'
  alt = 'Architecture diagram for the AWS security group audit workflow'
  caption = 'Centralized multi-account security group audit workflow'
  relative = true
+++
...
![IAM workflow](assets/iamworkflow.png)
...
![Lambda function configuration](assets/lambda.webp)
...
![Lambda environment variables](assets/lambda%20env.webp)
...
![Lambda timeout setting](assets/timeout.webp)
...
![Slack incoming webhook setup](assets/slack1.webp)
...
![Lambda test event](assets/lambdatest.webp)
...
![S3 report output](assets/s3%20report.webp)

![Markdown report output](assets/reportmd.webp)

![Slack webhook message](assets/slack%20webhook.webp)
...
![EventBridge scheduler](assets/schedular.webp)
...
![Schedule settings](assets/schedule%20setting.webp)
...
![Three-minute test schedule](assets/3min%20schedule.webp)
